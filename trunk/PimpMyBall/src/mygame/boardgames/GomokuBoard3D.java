...
public class GomokuBoard3D extends Node implements GomokuGame.Listener {
    ...
    private Vector3f animationStartPos, animationEndPos;
    ...
    public void animate(float tpf) {
        ...
        if (animate) {
            ...
            if (animationTime > 0) {
                ...
                // Vector3f temp = animationStartPos.clone();
                setLocalTranslation(animationStartPos.interpolate(animationEndPos, percent));
                // animationStartPos = temp;
    ...
    public Vector3f positionBetween(Vector3f v1, Vector3f v2) {
        ...
        animationStartPos = boardPos.add(0, -10, 0);
        animationEndPos = boardPos;
        
        setLocalTranslation(animationStartPos);
        
        return boardPos.clone();
    }
